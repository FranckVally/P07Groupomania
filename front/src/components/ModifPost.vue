  ...
  >
    <div class="modal-dialog">
      ...
      <div class="modal-content" v-if="editOption == 'modify'">
        <div class="modal-header">
          <h5 class="modal-title" id="ModalLabel">
            Voulez-vous modifier votre publication ?
          </h5>
          <button
            type="button"
            class="close"
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" @click="updatePost">
            Modifier
          </button>
        </div>
      </div>
      ...
      <div class="modal-content" v-else>
        <div class="modal-header">
          <h5 class="modal-title" id="ModalLabel">
            Supprimer ce post ? <span class="id">(id: {{ post.id }})</span>
          </h5>
          <button
            type="button"
            class="close"
  ...
  methods: {
    ...
    updatePost() {
      ...
      if (newContent && this.deleteImg) {
        axios
          .put(
            //requête put pour modifier le post existant avec la suppression de l'image
